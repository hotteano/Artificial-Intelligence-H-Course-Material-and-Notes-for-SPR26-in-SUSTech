...
To reduce candidate evaluation cost, IMRank provides a ranked pool from both campaigns, then only top candidates are evaluated in each greedy step.
...
\textbf{Hardware.}
\begin{itemize}
        \item CPU: \underline{\hspace{6cm}}
        \item RAM: \underline{\hspace{6cm}}
        \item OS: \underline{\hspace{6cm}}
\end{itemize}

\textbf{Algorithmic settings (default in scripts).}
\begin{itemize}
        \item Heuristic: MC scenarios per step $N=200$, IMRank iterations $=20$, candidate pool size $=1000$.
...
\begin{itemize}
        \item Base batch setting (map1/map2/map4/map5): \texttt{mc\_sim=200}, \texttt{max\_iter=20}, \texttt{candidate\_size=1000}, \texttt{seed=None}.
        \item map3 uses rerun result: \texttt{run\_initial=map3/seed2}, \texttt{mc\_sim=200}, \texttt{max\_iter=20}, \texttt{candidate\_size=3000}, \texttt{seed=None}; evaluation uses \texttt{simulations=60000}.
\end{itemize}

\begin{table}[h]
\centering
\caption{Table A. Heuristic runtime and final score (fill after run)}
\begin{tabular}{lcc}
\toprule
Case & Runtime (s) & Final Score \\
\midrule
map1 & 55.5138 & 452.9900 \\
map2 & 109.9021 & 36029.4305 \\
map3 & 268.8919 & 36217.9507 \\
map4 & 360.2779 & 6074.4319 \\
map5 & 146.1592 & 3080.1615 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[h]
\centering
\caption{Table C. Cross-method comparison (fill after run)}
\begin{tabular}{lcccc}
\toprule
Case & Heur. Runtime (s) & Heur. Score & Evol. Runtime (s) & Evol. Score \\
\midrule
map1 & 55.5138 & 452.9900 & 158.0262 & 449.6143 \\
map2 & 109.9021 & 36029.4305 & 146.2559 & 13660.3256 \\
map3 & 268.8919 & 36217.9507 & 192.3487 & 13680.5682 \\
map4 & 360.2779 & 6074.4319 & 20.3860 & 3188.0685 \\
map5 & 146.1592 & 3080.1615 & 22.6403 & 3146.8819 \\
\bottomrule
\end{tabular}
\end{table}
